...
[Click here](https://onlinedocs.microchip.com/v2/keyword-lookup?keyword=NET_APPS_SAM_9X7_TCP_IP_TCP_SERVER&redirect=true) to view documentation for this application.